...
public:
    ...
    /**
        ...
        */
    static GPUMatrix Identity(size_t n);
    ...
    /**
        ...
        */
    static GPUMatrix from_vector(const std::vector<Eigen::Vector3f>& p);

    /**
        * @brief Convert the matrix to a point list.
        * @return The point list.
        */
    std::vector<Eigen::Vector3f> to_vector() const;

    /**
        * @brief Convert the matrix to a float3 array.
        * @return The float3 array.
        */
    float3* to_float3(size_t length) const;
    ...
    /**
        ...
        * @return The new matrix.
        */
    static GPUMatrix from_cpu(const Eigen::MatrixXf& cpu);

    /**
        * @brief Convert the gpu matrix to a cpu matrix.
        * @return The new matrix.
        */
    Eigen::MatrixXf to_cpu() const;
    ...
    /**
        ...
        */
    static GPUMatrix find_covariance(const GPUMatrix& a, const GPUMatrix& b);
    ...
    /**
        ...
        */
    __device__ static float squared_distance(const GPUMatrix& a, size_t a_i, const GPUMatrix& b, size_t b_i)
    {
